  ...
  return (
    <section
      className={`mx-auto block h-[600px] max-sm:h-[400px] 
        overflow-hidden rounded-2xl bg-transparent ${className}`}
    >
      <div
        ...
        <div className="w-full overflow-hidden scale-90 sm:scale-100">
          ...
          >
            {imageGroups.map((imagesInGroup, idx) => (
              ...
              >
                <div className="absolute left-0 top-0 h-full w-0.5 bg-border/20" />
                {imagesInGroup.map((image, imgIdx) => {
                  ...
                  return (
                    <div key={`img-${imgIdx}`} className="relative">
                      <div className="absolute top-0 left-0 w-full h-0.5 bg-border/20" />
                      <motion.img
                        whileHover={{ y: -10 }}
                        ...
                        width={970}
                        height={700}
                        className={`aspect-[970/700] w-full max-w-[200px] rounded-lg object-cover ring ring-border/30 shadow-xl hover:shadow-2xl transition-shadow duration-300 ${
