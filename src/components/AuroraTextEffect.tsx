  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2
          className={cn(
            "font-extrabold tracking-tight relative overflow-hidden text-foreground",
            textClassName
          )}
          style={{ fontSize }}
        >
          {text}
          <div
            className="absolute inset-0 z-10 mix-blend-lighten dark:mix-blend-lighten pointer-events-none"
          >
            <div
              className={cn(
